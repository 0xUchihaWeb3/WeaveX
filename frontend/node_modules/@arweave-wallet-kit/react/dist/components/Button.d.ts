...
export declare const Button: import("react").ComponentType<Pick<import("react").ClassAttributes<HTMLButtonElement> & import("react").ButtonHTMLAttributes<HTMLButtonElement> & {
    ...
    as?: import("react").ElementType<any> | undefined;
}> & import("@linaria/react").WYWEvalMeta & import("react").FunctionComponent<import("react").ClassAttributes<HTMLButtonElement> & import("react").ButtonHTMLAttributes<HTMLButtonElement> & {
    theme: DefaultTheme;
} & {
    as?: import("react").ElementType<any> | undefined;
}>, {}>;
