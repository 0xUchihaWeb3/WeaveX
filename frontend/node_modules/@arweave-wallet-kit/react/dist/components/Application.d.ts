...
export declare function Application({ logo, name, description, onClick, theme }: Props): import("react/jsx-runtime").JSX.Element;
...
export declare const AppIcon: import("react").ComponentType<Pick<import("react").ClassAttributes<HTMLDivElement> & import("react").HTMLAttributes<HTMLDivElement> & {
    ...
    as?: import("react").ElementType<any> | undefined;
}> & import("@linaria/react").WYWEvalMeta & import("react").FunctionComponent<import("react").ClassAttributes<HTMLDivElement> & import("react").HTMLAttributes<HTMLDivElement> & {
    colorTheme?: string | undefined;
    clickable?: boolean | undefined;
    theme: DefaultTheme;
} & {
