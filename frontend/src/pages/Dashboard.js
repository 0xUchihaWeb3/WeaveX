...
var Dashboard = function () {
    ...
    var _c = useState(""), selectedToken = _c[0], setSelectedToken = _c[1]; // Update the initial state of output to an empty string
